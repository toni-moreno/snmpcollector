...
export class RuntimeComponent implements OnDestroy {
  ...
  /*7*/    { "show":true, "id": "SnmpOIDGetErrors","label": "OID With Errors","type":"counter", "tooltip": "numer of  oid with errors for all measurments"},
  ...
  /*13*/    { "show":true, "id": "MeasurementSent","label": "Measurement sent","type":"counter", "tooltip": "(number of  measurmenents build to send as a sigle request sent to the backend)"},
  ...
  /*18*/    { "show":true, "id": "FilterDuration","label": "Filter update Duration","type":"duration", "tooltip": "elapsed time taken to compute all aplicable filters on the device"},
